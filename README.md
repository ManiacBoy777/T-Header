...
`apt update && yes | apt upgrade && apt update && apt install git figlet pv binutils coreutils wget git zsh procps gawk exa neofetch lolcat libncurses5-dev libncursesw5-dev -y && git clone https://github.com/ManiacBoy777/T-Header.git && bash $HOME/T-Header/t-header.sh`
